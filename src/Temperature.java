/*
 * The base Temperature class, provides a foundation for the
 * concrete temperature classes that process temp data from
 * sensor.
 */
...
/**
 * Provides a range of functionality for the series of
 * temperature processing classes.
 * @author Spencer Little
 * @version 0.0.0
 */
public class Temperature implements WDataPoint {
